...
public interface IFilesManager {
     ...
     */
    public abstract List<StorageStatus> addFiles(Map<IFile, byte[]> files, User user, DocumentType docType,
    ...
    /**
     * This method changes access type for document and all files attached as pages
     * to this document to provided new access type
     *
     ...
     */
    public abstract boolean changeDocumentAccess(IDocument doc, DocumentAccess docAccess)
